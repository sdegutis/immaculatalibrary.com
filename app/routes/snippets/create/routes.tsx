...
const MonacoClientSide = () => <>
  ...
  <script src={staticRouteFor({
    name: 'fix-remote-monaco.js',
    buffer: Buffer.from(`var require = { paths: { 'vs': 'https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/0.31.1/min/vs' } }`),
  })}></script>
